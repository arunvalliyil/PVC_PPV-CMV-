...
class FuseOverrideGenerator():
    ...
    def generate_fuse_override(self):
        ...
        for domain in cache.SET_FREQUENCY:
            ...
            if 'COMPUTE' in domain.upper() or 'BASE' in domain.upper(): # force both base and compute to run at same frequency
                ...
                set_fuse_overrides.append('punit.pcode_gt_max_chiplet_ifc_multiplier= 0xC0')
    ...
    def fuses_to_set_eu_voltage_points(self,voltage):
        '''
    ...
    def fuses_to_set_base_voltage_point(self, voltage):
        return_val = []
        for point in range(6):
            return_val.append('punit.pcode_gt_ro3d_vf_voltage_curve0_voltage_index0_voltage_point{}= {}'.format(point,voltage))
        return_val.append('punit.pcode_initial_wp_active_voltage_iio_domain0={}'.format(voltage))
        return_val.append('punit.pcode_initial_wp_active_voltage_hbm_domain0={}'.format(voltage))
        return return_val
